...
@section('content')
    @component('components.admin.form.form',['action'=>route('admin.page.store'),'method'=>'post','pic_upload'=>true])
        @slot('content')
            ...
            @component('components.admin.form.upload_file',['title'=>'ویدیو','id'=>'video','name'=>'video'])@endcomponent
            @component('components.admin.form.input',['title'=>'آدرس','name'=>'address','value'=>old('address')])@endcomponent
