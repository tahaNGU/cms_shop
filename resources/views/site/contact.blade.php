            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white rounded-3xl p-4">
                ...
                <div class="p-4">
                    ...
                    @if(session()->has('success'))
                        <div class="text" style="color: green">{{session()->get('success')}}</div>
                    @endif
                    <form action="{{route('contact_store')}}" method="post">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="email" class="input input-bordered w-full" name="email" value="{{old('email')}}"/>
                            <label class="label">
                                <span class="label-text-alt">متن پیام:</span>
                            </label>
                            <textarea class="textarea textarea-bordered h-24" placeholder="متن پیام را بنویسید..." name="msg" >{{old('msg')}}</textarea>
                            <button class="btn bg-stone-800 hover:bg-stone-900 text-white my-3" type="submit">ارسال پیام</button>
                        </div>
                    </form>
        ...
        <div class="container mx-auto max-w-screen-xl">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-1.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-2.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-3.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-5.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-6.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="flex justify-center">
                                <img src="/site/assets/images/logo-4.png" alt="">
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-12 gap-4 leading-8">
                <div class="col-span-12 lg:col-span-5">
                    <img class="mb-4" src="/site/assets/images/logo.png" alt="">
                    <p>
                ...
                <div class="col-span-12 lg:col-span-3">
                    ...
                    <div class="flex items-center">
                        <img src="/site/assets/images/enamad_logo.png" alt="">
                        <img src="/site/assets/images/samandehi_logo.png" alt="">
                    </div>
                </div>
            </div>
        </div>
