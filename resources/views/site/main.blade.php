                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                ...
                                <div>
                                    <a href="javascript:void(0)"><h3 class="font-YekanBakh-ExtraBold text-base">{{$product["title"]}}</h3></a>
                                    <div class="flex justify-center gap-4 text-base mt-4">
                                        @if(isset($product_variation))
{{--                                        <span class="line-through">45.000 تومان</span>--}}
                                        <span class="text-yellow-500">{{number_format($product_variation['price'])}}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
