...
@section('content')
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                <div>
                                    <a href="single-product.html"> <img class="w-32"
                                                                        src="{{asset('site/assets/images/product-4.jpg')}}"
                                                                        alt=""></a>
                                </div>
                                <div>
                                    <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه
                                            ingco</h3></a>
                                    <div class="flex justify-center gap-4 text-base mt-4">
                            ...
                            <div class="flex items-center text-sm justify-center gap-4">
                                ...
                                <div>
                                    <progress class="progress progress-warning w-48 md:w-56" value="70"
                                              max="100"></progress>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                <div>
                                    <a href="single-product.html"> <img class="w-32"
                                                                        src="{{asset('site/assets/images/product-3.jpg')}}"
                                                                        alt=""></a>
                                </div>
                                <div>
                                    <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                <div>
                                    <a href="single-product.html"> <img class="w-32"
                                                                        src="{{asset('site/assets/images/product-2.jpg')}}"
                                                                        alt=""></a>
                                </div>
                                <div>
                                    <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دریل
                                            چکشی با کیف</h3></a>
                                    <div class="flex justify-center gap-4 text-base mt-4">
                                        <span class="line-through">50.000 تومان</span>
                                        <span class="text-yellow-500">45.000 تومان</span>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                <div>
                                    <a href="single-product.html"> <img class="w-32"
                                                                        src="{{asset('site/assets/images/product-1.jpg')}}"
                                                                        alt=""></a>
                                </div>
                                <div>
                                    <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دریل
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 relative p-4">
                            <div class="flex items-center justify-center">
                                <div>
                                    <a href="single-product.html"> <img class="w-32"
                                                                        src="{{asset('site/assets/images/product-8.jpg')}}"
                                                                        alt=""></a>
                                </div>
                                <div>
                                    <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دریل
                                            شارژی مدل دیوالت</h3></a>
                                    <div class="flex justify-center gap-4 text-base mt-4">
                                        <span class="line-through">50.000 تومان</span>
                                        <span class="text-yellow-500">45.000 تومان</span>
                                    </div>
    ...
    <section class="my-14 px-4">
        <div class="container mx-auto max-w-screen-xl">
            <img class="rounded-2xl" src="{{asset('site/assets/images/pic.jpg')}}" alt="">
        </div>
    </section>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-5.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">کیف کمری
                                        ابزار</h3></a>
                                <div class="flex justify-center gap-4 text-base mt-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <div class="relative">
                                <a href="single-product.html" class="flex flex-col items-center justify-center">
                                    <img class="mb-4" src="{{asset('site/assets/images/product-8.jpg')}}" alt="">
                                </a>
                            ...
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دلر شارژی
                                        مدل دیوالت</h3></a>
                                <div class="flex justify-center gap-4 text-base mt-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-4.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه مدل
                                        Ingco</h3></a>
                                <div class="flex justify-center gap-4 text-base mt-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-3.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه پمپ
                                        باد</h3></a>
                                <div class="flex justify-center gap-4 text-base mt-4">
                                    <span class="line-through">50.000 تومان</span>
                                    <span class="text-yellow-500">45.000 تومان</span>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-1.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دریل برقی
                                        مدل X</h3></a>
                                <div class="flex justify-center gap-4 text-base mt-4">
                                    <span class="line-through">50.000 تومان</span>
                                    <span class="text-yellow-500">45.000 تومان</span>
    ...
    <section class="my-14 px-4">
        <div class="container mx-auto max-w-screen-xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <img class="rounded-3xl" src="{{asset('site/assets/images/11.png')}}" alt="">
                </div>
                <div>
                    <img class="rounded-3xl" src="{{asset('site/assets/images/12.png')}}" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="swiper slider-product1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-2.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">کیف کمری
                                        ابزار</h3></a>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            <a href="single-product.html" class="flex flex-col items-center justify-center">
                                <img class="mb-4" src="{{asset('site/assets/images/product-7.jpg')}}" alt="">
                            </a>
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">دستگاه مدل
                                        Ingco</h3></a>
        ...
        <div class="container mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="bg-white p-4 rounded-3xl">
                    <div class="relative">
                        <a href="single-page.html"><img class="rounded-2xl"
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <div>
                            <a href="single-page.html"><h3 class="font-YekanBakh-ExtraBold text-base">راهنمای خرید انواع
                                    مته</h3></a>
                        </div>
                        <div>
                ...
                <div class="bg-white p-4 rounded-3xl">
                    <div class="relative">
                        <a href="single-page.html"><img class="rounded-2xl"
                                                        src="{{asset('site/assets/images/blog-2.jpg')}}" alt=""></a>
                        <div class="absolute top-4 left-4 bg-white border-t-4 border-yellow-400 p-2 px-3 rounded-xl">
                            <div class="flex flex-col">
                                <span class="font-YekanBakh-ExtraBold text-2xl">26</span>
                                <span class="font-YekanBakh-Bold">خرداد</span>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <div>
                            <a href="single-page.html"><h3 class="font-YekanBakh-ExtraBold text-base">تعمیر قلاب
                                    ماهیگیری</h3></a>
                        </div>
                        <div>
                            <a class="flex items-center" href="single-page.html">
                ...
                <div class="bg-white p-4 rounded-3xl">
                    <div class="relative">
                        <a href="single-page.html"><img class="rounded-2xl"
                                                        src="{{asset('site/assets/images/blog-3.jpg')}}" alt=""></a>
                        <div class="absolute top-4 left-4 bg-white border-t-4 border-yellow-400 p-2 px-3 rounded-xl">
                            <div class="flex flex-col">
                                <span class="font-YekanBakh-ExtraBold text-2xl">26</span>
                                <span class="font-YekanBakh-Bold">خرداد</span>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <div>
                            <a href="single-page.html"><h3 class="font-YekanBakh-ExtraBold text-base">تمیز کردن لوازم
                                    کارگاهی</h3></a>
                        </div>
                        <div>
