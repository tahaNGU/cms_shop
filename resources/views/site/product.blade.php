                    ...
                    <div class="bg-white rounded-3xl mb-4 p-4">
                        ...
                        <div class="my-4">
                            <ul class="menu">
                                ...
                                <li>
                                    <details open>
                                        <summary>{{$product_cat['title']}}</summary>
                                        <ul>
                    ...
                    <div class="bg-white rounded-3xl p-4">
                        ...
                        <div class="flex flex-col mt-4 gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <input type="radio" name="radio-6" value="{{$brand['id']}}" class="radio radio-warning" checked />
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-white rounded-3xl leading-10 p-4">
                            ...
                            <div class="text-center">
                                <a href="single-product.html"><h3 class="font-YekanBakh-ExtraBold text-base">{{$product['title']}}</h3></a>
